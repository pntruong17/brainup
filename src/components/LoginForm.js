            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
                    ...
                    <div className="max-w-lg bg-white rounded-lg p-8 flex flex-col mx-auto w-full mt-10 md:mt-0 shadow-2xl">
                        <h2 className="text-gray-900 text-lg font-medium title-font mb-5">Sign in to use the service</h2>
                        ...
                        <button className="text-white bg-black border border-black py-2 px-8 focus:outline-none hover:bg-white hover:text-black rounded text-lg transition duration-100">Sign In</button>
                        <p className="text-xs text-gray-500 mt-3">Literally you probably haven&apos;t heard of them jean shorts.</p>
                        <p className="text-md text-gray-500 mt-3 text-center">Or sign in with</p>
                        <button
                            onClick={GoogleLogin}
